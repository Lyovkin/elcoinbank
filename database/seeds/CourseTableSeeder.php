...
class CourseTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('course')->insert([
            ...
            ['currency_id' => $currencies[2]['id'], 'course_purchase' => 0.03, 'course_sell' => 0.15],
            ['currency_id' => $currencies[3]['id'], 'course_purchase' => 2.0, 'course_sell' => 5.0],
            ['currency_id' => $currencies[4]['id'], 'course_purchase' => 2.0, 'course_sell' => 4.8],
            ...
            ['currency_id' => $currencies[9]['id'], 'course_purchase' => 0.00005, 'course_sell' => 0.00014],
        ]);
